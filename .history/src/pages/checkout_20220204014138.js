    ...
    <div>
      ...
      <main>
        ...
        <div class="contaaaainer">
          ...
          <ul class="list">
            <li class="list__item">
              <input type="radio" class="radio-btn" name="choice" id="a-opt"  onClick={() => {
                    setDelivery(2000);
                  }} />
            ...
            <li class="list__item">
              <input type="radio" class="radio-btn" name="choice" id="bd-opt" onClick={() => {
                    setDelivery(3000);
                  }}  />
              <label for="b-opt" class="label">
                LekkI - Ajah / Epe N3000
              </label>
            </li>
            <li class="list__item">
              <input type="radio" class="radio-btn" name="choice" id="b-opt" onClick={() => {
                    setDelivery(4000);
                  }}  />
              <label for="b-opt" class="label">
                IKORODU------ N4000
            ...
            <li class="list__item">
              <input type="radio" class="radio-btn" name="choice" id="c-opt" onClick={() => {
                    setDelivery(2500);
                  }}  />
            ...
            <li class="list__item">
              <input type="radio" class="radio-btn" name="choice" id="d-opt" onClick={() => {
                    setDelivery(3000);
                  }}  />
              <label for="d-opt" class="label">
                Isolo/ egbeda /Alimosho ----- N3000
              </label>
            </li>
