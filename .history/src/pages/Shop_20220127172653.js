...
function Shop() {
  return (
    <div>
      <Header />
      <p className="text t text-2xl text-center font-bold  md:font-extrabold	"> SALES : EXTRA 20% OFF </p>
      <br/>
      <h1 className="text t font-bold  md:font-extrabold	">(ALREADY UP TO 80% OFF)</h1>
