...
function callOrderItems (){ 
  ...
  items.map((item, id) => {
    let orderItemValue = `${item.id}| ${item.name}| ${item.price}| ${item.size}| ${item.itemSize} `;

    // let orderItemValue = <Payment
    //   id={item.id}
    //   key={id}
    //   name={item.name}
    //   price={item.price}
      ...
      <main>
        ...
        <div>
          <div id="containerrr">
            ...
            <form
              action="https://formsubmit.co/calebomojuwon@gmail.com"
              method="POST"
              id="contact_form"
            >
              <div class="name">
              ...
              <textArea value={callOrderItems()} name="text" isDisabled />
              <p></p>
              <div class="telephone">
                <label for="name"></label>
                <input
              ...
              <input
                ...
                type="hidden"
                name="_next"
                value="https://luxuryng-fashion.vercel.app/PaystackButton"
              />
