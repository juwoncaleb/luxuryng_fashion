      ...
      <main>
        ...
        <h3 className="text-white	"> Lagos Island</h3>
          <ul class="list">
            ...
            <h3 className="text-white	"> OUTSIDE LAGOS</h3>
