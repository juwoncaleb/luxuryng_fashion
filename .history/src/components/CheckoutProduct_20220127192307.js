  ...
  return (
	...
	<form action="/p/quote.php" method="GET" className="option" >
		<div className="debt-amount-slider">
			...
			<label for="1" data-debt-amount="XXL" onClick={()=>{
                                    setItemSize("XCL")
                                }} ></label>
			<input type="radio" name="debt-amount" id="2" value="2" required/>
			<label for="2" data-debt-amount="XL" onClick={()=>{
                                    setItemSize("XL")
                                }} ></label>
			<input type="radio" name="debt-amount" id="3" value="3" required/>
			<label for="3" data-debt-amount="L" onClick={()=>{
                                    setItemSize("L")
                                }} ></label>
			<input type="radio" name="debt-amount" id="4" value="4" required/>
			<label for="4" data-debt-amount="M" onClick={()=>{
                                    setItemSize("M")
                                }} ></label>
			<input type="radio" name="debt-amount" id="5" value="5" required/>
			<label for="5" data-debt-amount="S" onClick={()=>{
                                    setItemSize("XL")
                                }} ></label>
