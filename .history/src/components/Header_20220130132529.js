            ...
            <Container className=" header	"  >
                ...
                <Navbar.Collapse className="ml-10" id="navbarScroll">
                    ...
                    <Nav className=" ham" style={{ maxHeight: '500px' }} navbarScroll  >
                        ...
                        <Nav.Link onClick={() => router.push('/About')} className="ml-10 mt-1 capp text-white" href="#action2"><p >Abou</p></Nav.Link>
                        <Nav.Link onClick={() => router.push('/Contact')} className="ml-10 mt-1 capp text-white" href="#action2"><p >CAPS</p></Nav.Link>
