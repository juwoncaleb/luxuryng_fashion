            ...
            <Container className=" header	"  >
                ...
                <Navbar.Collapse className="ml-10" id="navbarScroll">
                    ...
                    <Nav className="" style={{ maxHeight: '500px' }} navbarScroll  >
                        ...
                        <Nav.Link onClick={() => router.push('/Caps')} className="ml-10 mt-1 text-w" href="#action2"><p >CAPS</p></Nav.Link>
                        <Nav.Link onClick={() => router.push('/Caps')} className="ml-10 mt-1" href="#action2"><p >BRAND</p></Nav.Link>
