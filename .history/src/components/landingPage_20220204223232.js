          ...
          >
            <div>
              ...
              <div className="w-full h-full flex flex-col absolute top-6   justify-center items-center">
                ...
                <h3 className="text-white font-bold text t headerText">Your one stop shop for high end streetwear.</h3>
                <br />
                <br />
                <br />
            ...
            <div className="">
              ...
              <div className="w-full h-full flex flex-col absolute top-6  justify-center items-center">
                ...
                <h3 className="text-black t font-bold text landingpagetext">Your one stop shop for high end streetwear.</h3>
            ...
            <div className="">
              ...
              <div className="w-full h-full flex flex-col absolute top-6   justify-center items-center">
                ...
                <h3 className="text-white t font-bold text landingpagetext">Your one stop shop for high end streetwear.</h3>
