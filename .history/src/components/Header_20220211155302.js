    ...
    return (
        ...
        <Navbar className="bg-black " expand="lg" sticky="top">
            <Container className=" header	"  >
                ...
                <img className="logoImage cursor-pointer	" onClick={() => router.push('/')}
                    src="/img/logo.png" />
                ...
                <Navbar.Collapse className="ml-10" id="navbarScroll">
                    ...
                    <Nav className=" ham" style={{ maxHeight: '500px' }} navbarScroll  >
                        ...
                        <NavDropdown className="ml-10 mt-1 text-navbar text-base font-medium shirtt"
                            title={<span className=" text-white text-base my-auto">Home</span>} id="dropdown-button-dark-example1" onClick={() => router.push('/')}>
                            

                        </NavDropdown>
                        <NavDropdown className="ml-10 mt-1 trouserrs"
                            title={<span className="text-white my-auto">About Us</span>} id="basic-nav-dropdown" onClick={() => router.push('/About')}>
                        </NavDropdown>
                        <NavDropdown className="ml-10 mt-1 footwear"
                            title={<span className="text-white my-auto">All Products</span>} id="basic-nav-dropdown" onClick={() => router.push('/Shop')}>
