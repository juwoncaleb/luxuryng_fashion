  ...
  return (
    <div>
      ...
      <div className="bg-white mt-16  page ">
        <div class="container">
          <h1 class="neon text-3xl">Top selling this week</h1>
        </div>
        <br />
        <br />
        <div className="topSelling">
          ...
          <div className="clothes content-center  pl-2	 ">
            ...
            />
            <Image width={350} height={280} src="/img/balenciaga/swis.png" />
            <Image width={350} height={280} src="/img/travis/rot1.png" />
            ...
            <Image width={350} height={280} src="/img/travis/cac.png" />
          </div>
          <br />
          <br />
          <div class="container">
            <a class="btn">Click me baby yeah</a>
        ...
        <div className="newArrival">
          ...
          <div className="clothes content-center  pl-2	 ">
            <Image width={350} height={280} src="/img/balenciaga/rp1.png" />
