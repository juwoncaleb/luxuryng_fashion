  ...
  return (
    <div className=" bg-black naviBar ">
      ...
      <div className="grid bg-black ">
        <img
          className="logoImage cursor-pointer mobile 	"
          onClick={() => router.push("/")}
          src="/img/logo.png"
        />
        <p className="text-white mt-4 flex-1 mobileImage">Home</p>
        <p className="text-white mt-4 flex-1 mobileImage">Home</p>
        <p className="text-white mt-4 flex-1 mobileImage">Home</p>
        <p className="text-white mt-4 flex-1 mobileImage">Home</p>
        <input className="navSearch  mt-4 mobileImage"></input>
        <p className="text-white ml-4 mt-4 mobileImage flex-1">
          <Icon icon="akar-icons:search" color="white" width="30" />
        </p>
