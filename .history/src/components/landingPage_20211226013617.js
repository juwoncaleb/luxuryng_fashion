    ...
    return (
        <div>
            ...
            <div className="bg-white l  page ">
                ...
                <div className=" ">
                    <p className="text-center text-black text-3xl	 font-semibold md:text-5xl lg:text-5xl ">Welcome to luxury Wears</p>

                    <p className="text-center text-black text-3xl	 font-semibold md:text-5xl lg:text-5xl 	">Your one stop shop for High-end streetwear</p>
                    <p className="text-center text-black text-3xl	 font-semibold md:text-5xl lg:text-5xl 	">Open Mon - Saturday (10am-6pm)</p>
                    <p className="text-center text-black text-3xl	 font-semibold md:text-5xl lg:text-5xl 	">We deliver </p>
