    ...
    <div>
      <div className="landscape flex fixed  ">
        <img
          ...
          src="/img/logo.png"
        />
        <p onClick={() => router.push("/")} className="text-white cursor-pointer flex-1 mt-4 togglebutton">Home</p>
        <p onClick={() => router.push("/About")} className="text-white cursor-pointer flex-1 mt-4 togglebutton">About Us</p>
        <p onClick={() => router.push("/Shop")} className="text-white cursor-pointer flex-1 mt-4 togglebutton">Clothing</p>
