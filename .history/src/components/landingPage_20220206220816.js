          ...
          >
            <div>
              ...
              <div className="w-full h-full flex flex-col absolute top-6   justify-center items-center">
                ...
                <p className="text-white font-bold text t headerText">Your one stop shop for <br/> High end streetwear.</p>
                <br />
                <br />
                <br />
            ...
            <div className="">
              ...
              <div className="w-full h-full flex flex-col absolute top-6  justify-center items-center">
                ...
                <p className="text-black t font-bold text landingpagetext">Your one stop shop for <br/> High end streetwear.</p>
            ...
            <div className="">
              ...
              <div className="w-full h-full flex flex-col absolute top-6   justify-center items-center">
                ...
                <p className="text-white t font-bold text landingpagetext">Your one stop shop for <br/> High end streetwear.</p>
