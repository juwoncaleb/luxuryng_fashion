  ...
  return (
   <div>
      ...
      <div className="flex  navsub ">
        ...
        <p className="text-white  mt-4 flex-1 togglebutton ">Clothings</p>
    ...
    <img
      ...
      src="/img/logo.png"
    />
    <p className="text-white  flex-1 mobileImage">About us</p>
    <p className="text-white  flex-1 mobileImage">Clothings</p>
    <input className="navSearchMobile   mobileImage"></input>
