          ...
          >
            <div>
              ...
              <div className="w-full h-full flex flex-col absolute top-6   justify-center items-center">
                ...
                <p className="text-2xl t font-bold text-white">Your one stop shop for <br/> High end streetwear.</p>
                <br />
                <br />
                <br />
            ...
            <div className="">
              ...
              <div className="w-full h-full flex flex-col absolute top-6  justify-center items-center">
                ...
                <p className="text-2xl t font-bold ">Your one stop shop for <br/> High end streetwear.</p>
