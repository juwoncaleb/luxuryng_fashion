          ...
          >
            <div>
              ...
              <div className="w-full h-full flex flex-col absolute top-6   justify-center items-center">
                <h1 className="text-white font-bold text headerText">
                  LUXURY CLOSET
                </h1>
                <br />
                <br />
                <br />
                  ...
                  <button class="buttoooon">SHOP NOW</button>
            ...
            <div className="">
              ...
              <div className="w-full h-full flex flex-col absolute top-6  justify-center items-center">
                ...
                <br />
                <br />
                <button class="buttoooon" onClick={() => router.push('/Payment')}>SHOP NOW</button>
