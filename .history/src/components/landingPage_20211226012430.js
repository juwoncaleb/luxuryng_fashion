            ...
            <div className="bg-white l  page ">
                ...
                <div className="clothes content-center ml-16 pl-2	 ">
                    <div className="inline-block">
                        ...
                        />
                        <p className=" text-black text-lg inline-block	 font-semibold md:text-5xl lg:text-5xl ">Best Selling</p>
                    ...
                    <div  className="inline-block">
                        ...
                        />
                        <p className=" text-black text-lg inline-block	 font-semibold md:text-5xl lg:text-5xl ">New Arivals</p>
                    ...
                    <div  className="inline-block">
                        ...
                        />
                        <p className=" text-black text-lg inline-block	 font-semibold md:text-5xl lg:text-5xl ">Popular</p>
                    ...
                    <div  className="inline-block">
                        ...
                        />
                        <p className=" text-black text-lg	inline-block font-semibold md:text-5xl lg:text-5xl ">urban(dont know what to put here)</p>
