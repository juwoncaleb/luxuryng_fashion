        ...
        <div>
            ...
            <div className="bg-white l  page ">
                ...
                <div className=" ">
                    ...
                    <p className="text-center text-navbar text-2xl	 font-semibold md:text-5xl lg:text-5xl 	">Your one stop shop for High-end streetwear</p>
                    <p className="text-center text-navbar text-2xl	 font-semibold md:text-5xl lg:text-5xl 	">Open Mon - Saturday (10am-6pm)</p>
                    <p className="text-center text-navbar text-2xl	 font-semibold md:text-5xl lg:text-5xl 	">We deliver </p>
                    ...
                    <div class="col-12 col-md-4 col-sm-12 col-xs-12">
                        <div class="card p-3 p-md-4 text-white"> <span><i class="fa fa-envelope-open-o fa-2x" aria-hidden="true"></i></span>
                            ...
                            <div class="row d-flex my-2 pr-2 pr-md-5 div1">
                                ...
                                <div class="col-3 px-0"> <button class="btn text-white px-4 py-2"> OK </button> </div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer">
                ...
                <div class="content">
                    <div class="services">
                        <h4>SUBSCRUBE TO OUR NEWSLETTER</h4>
                        <input />
                        <button>jf</button>
                    </div>
