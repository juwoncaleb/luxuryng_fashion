                ...
                <div class="page2_sub  flex">
                    ...
                    <div class="page2_sub_container pt-20">
                        <div className="box">
                            ...
                            /><span className="text-center movy text-navbar text-base font-semibold">NIKE</span>
                        </div>
                        <div class="box">
                            <img
                            ...
                            /><span className="text-center movy text-navbar text-2xl font-semibold">FEAR OF GOD</span>
                        </div>
                        <div class="box">
                            <img
                            ...
                            /><span className="text-center movy text-whi text-2xl font-semibold">GUCCI</span>
                        </div>
                        <div class="box">
                            <img
