...
function Items({ id, name, price, size, image }) {
  ...
  window.onload = function () {
    ...
    //// SLIDER
    var slider = document.getElementsByclass("sliderBlock_items");
    var slides = document.getElementsByclass("sliderBlock_items__itemPhoto");
    var next = document.getElementsByclass("sliderBlock_controls__arrowForward")[0];
    var previous = document.getElementsByclass("sliderBlock_controls__arrowBackward")[0];
    var items = document.getElementsByclass("sliderBlock_positionControls")[0];
    var currentSlideItem = document.getElementsByclass("sliderBlock_positionControls__paginatorItem");
    ...
    function goToSlide(n) {
        slides[currentSlide].class = 'sliderBlock_items__itemPhoto';
        items.children[currentSlide].class='sliderBlock_positionControls__paginatorItem';
        currentSlide = (n + slides.length) % slides.length;
        slides[currentSlide].class = 'sliderBlock_items__itemPhoto sliderBlock_items__showing';
        items.children[currentSlide].class = 'sliderBlock_positionControls__paginatorItem sliderBlock_positionControls__active';
    }
...
///// Specification Field
    ...
    var buttonFullSpecification = document.getElementsByclass("block_specification")[0];
    var buttonSpecification = document.getElementsByclass("block_specification__specificationShow")[0];
    var buttonInformation = document.getElementsByclass("block_specification__informationShow")[0];
...
/////  QUANTITY ITEMS
    ...
    var up = document.getElementsByclass('block_quantity__up')[0],
        down = document.getElementsByclass('block_quantity__down')[0],
        input = document.getElementsByclass('block_quantity__number')[0];
...
const [active, setActive] = useState("");
  ...
  return (
    <div class="w-screen">
      <div class=" w-full	 flex-col m-0 md:m-5 bg-white z-30 p-10">
        <div class="relative flex flex-col w-full m-0 md:m-5 bg-white z-30 p-10">
          <main class="main">
                            ...
                            <div class="block_product">
                              ...
                              <div class="block_informationAboutDevice">
                                ...
                                <div class="block_rating clearfix">
                                  ...
                                  <span class="block_rating__avarage">
                                    4.25
                                  </span>
