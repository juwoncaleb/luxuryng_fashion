...
function Items({ id, name, price, size, image }) {
  ...
  window.onload = function () {
    ...
    var next = document.getElementById("sliderBlock_controls__arrowForward");
    var previous = document.getElementById("sliderBlock_controls__arrowBackward");
    var items = document.getElementById("sliderBlock_positionControls");
...
///// Specification Field
    ...
    var buttonFullSpecification = document.getElementById("block_specification");
    var buttonSpecification = document.getElementById("block_specification__specificationShow");
    var buttonInformation = document.getElementById("block_specification__informationShow");
...
/////  QUANTITY ITEMS
    ...
    var up = document.getElementById('block_quantity__up'),
        down = document.getElementById('block_quantity__down'),
        input = document.getElementById('block_quantity__number');
