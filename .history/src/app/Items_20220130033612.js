...
function Items({ id, name, price, size, image , original , thumbnail }) {
  ...
  <div class="cards">
    <label class="card" for="item-1" id="song-1">
      <img cl src="https://images.unsplash.com/photo-1530651788726-1dbf58eeef1f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=882&q=80" alt="song"/>
    </label>
