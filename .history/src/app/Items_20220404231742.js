      ...
      <div className="itemContainer w-full	 flex-col m-0 md:m-5 bg-white z-30 p-10">
        <div className=" flex flex-col w-full m-0 md:m-5 bg-white z-30 p-10">
          <div className="bg-gray">
            <div>
              {" "}
              <img src={image1} width="550" />{" "}
            </div>

            <div className=" flex priceName  ">
              <h4 className="text-center t font-bold itemName	">{name}</h4>
              
<span>               <h4 className="text-center t font-bold itemName	">{itemSize}</h4>
</span>
              <span>

                {" "}
                <h4 className="text-center t font-bold itemName	">{count}</h4>
              </span>
              <h4 className="text-center t font-bold itemName itemPrice	">
                {price}
              </h4>
            </div>
            <div class="itt flex ">
              ...
              <div className="flex quantit mt-2">
                <p
                  ...
                  className="increasePlus cursor-pointer"
                >
                  +
                </p>
                <p
                  ...
                  className="decreaseMinus cursor-pointer"
                >
                  -
                </p>
              </div>
              <p
                ...
                className="mt-2 cursor-pointer pr-10"
              >
                Add to Cart{" "}
              </p>
            </div>
